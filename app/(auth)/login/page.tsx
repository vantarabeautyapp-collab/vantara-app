          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative py-3">
              ...
              <div className="relative flex justify-center">
                <span className="px-3 text-xs text-text-muted bg-[#0A0A0A]">or continue with</span>
              </div>
            </div>

            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-border text-text-secondary text-sm font-medium hover:bg-surface-hover hover:border-border transition-all duration-150"
            >
